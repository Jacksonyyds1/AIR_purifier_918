...
//uint32_t ccr2_val = 250;
static uint32_t ccr2_val = 0;
...
/**
*@brief pwm timr3 ch2 init
*@param none
*@retval none
*/
void pwm_timr3_init(void)
{
  ...
  /* tmr2 time base configuration */
	//PWM频率 = 系统时钟频率 / ((prescaler + 1) × (period + 1))
  tmr_base_init(TMR2, 999, 71); //1kHz
	//tmr_base_init(TMR2, 499, 71); //2KHz
